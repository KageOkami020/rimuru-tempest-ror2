...
- v1.1.3
    - Recompiled with new versions of MMHOOK
    - Added option to permanently keep buffs
        - *Gives gun to player* 
            - *Go, do crime*
                - *Activates all 42 buffs and crashes ror2* 
    - Added option to change how much time is refreshed when consuming the same buff.
- v1.0.0 
